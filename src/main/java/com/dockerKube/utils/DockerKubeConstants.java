...
public class DockerKubeConstants {
	...
	public static final String KUBE_REQUIREMENTS_FILE="requirements.txt";
	public static final String KUBE_PATH_REQUIREMENTS_FILE="deploy/private/requirements.txt";
	public static final String KUBE_DEPLOYMENT_FILE="deployment-readme.txt";
	public static final String KUBE_PATH_DEPLOYMENT_FILE="docs/deployment-readme.txt";
	public static final String KUBE_PROTOBUF_FILE="protobuf/orchestrator.proto";
	public static final String KUBE_PATH_PROTOBUF_FILE="deploy/private/protobuf/orchestrator.proto";
